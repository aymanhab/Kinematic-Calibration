function [tree, RootName, DOMnode] = xmlRead(xmlfile, Pref)
%XMLREAD reads xml files and converts them into Matlab's struct tree.
%
% DESCRIPTION
% tree = xmlRead(xmlfile) reads 'xmlfile' into data structure 'tree'
%
% tree = xmlRead(xmlfile, Pref) reads 'xmlfile' into data structure 'tree'
% according to your preferences
%
% [tree, RootName, DOMnode] = xmlRead(xmlfile) get additional information
% about XML file
%
% INPUT:
...
%
% DETAILS:
% Function xmlRead first calls MATLAB's xmlread function and than
...
%   [tree treeName] = xmlRead ('test.xml');
%   disp(treeName)
%   gen_object_display()
